 ...
 * 4. 사진을 탭하면 해당 사진의 상세 보기 화면(PhotoDetailScreen)으로 이동합니다.
 ...
 * - 사진을 탭하면 전체 사진 목록과 탭한 사진의 인덱스를 PhotoDetailScreen 위젯에 전달합니다.
 * 
 * 주요 위젯:
...
import 'photo_detail_screen.dart'; // 상세 화면 임포트
