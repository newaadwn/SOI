 ...
 * 5. 카테고리를 탭하면 해당 카테고리에 포함된 모든 사진을 볼 수 있는 ShowPhotoScreen으로 이동합니다.
 * 
 * 데이터 흐름:
 * - AuthViewModel: 사용자의 닉네임을 Firebase에서 가져오는 역할을 합니다.
 * - CategoryViewModel: 사용자의 카테고리 정보를 실시간으로 스트리밍합니다.
