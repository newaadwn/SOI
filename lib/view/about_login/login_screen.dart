...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool userExists = true; // 기본값은 true (사용자 존재 가정)
  bool isVerified = false; // 인증 완료 여부
  bool isCheckingUser = false; // 사용자 확인 중 여부
                  ...
                  ? isCheckingUser
                      ...
                      : ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          // SMS 코드로 인증 시도
                          _authViewModel.signInWithSmsCode(smsCode, () async {
                            // 인증 성공 후, Firestore에서 사용자 확인
                            final userDoc = await _authViewModel
                            ...
                            if (userExists) {
                              // 사용자가 존재하면 카메라 페이지로 이동
                              // 이전 페이지들을 모두 삭제하고 홈 화면으로 이동
                              ...
                              // 사용자가 존재하지 않을 때 UI 업데이트를 위해 상태 변경 후 setState 호출
                              setState(() {
