...
/// AudioViewModel을 사용하여 녹음 및 업로드 로직을 처리합니다.
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                if (isRecording)
                  Text(
                    viewModel.formattedRecordingDuration,
                    style: TextStyle(
                      color: Colors.white,
